...
.slider-text a:before {
  ...
  border-style: solid;
  border-color: rgba(239, 0, 0, 0) #23272a rgba(0, 128, 0, 0)
    rgba(35, 39, 42, 0);
}
.slider-img {
  float: right;
...
.content-bottom-right h3,
.content-bottom-right h3:before,
.buters-guide {
  margin-top: 2em;
}
.buters-guide p {
    ...
    <div class="wrap">
      ...
      <div class="header_bottom">
        <div class="slider-text">
          <h2>
            Lorem Ipsum Placerat
            <br />
            Elementum Quistue Tunulla Maris
          </h2>
          <p>
            Vivamus vitae augue at quam frigilla tristique sit amet acin ante
            siku mpre tisdin.
          </p>
        ...
        <div class="wrap">
          <div class="content-bottom-left">
            <div class="buters-guide">
              <h3>Buyers Guide</h3>
              <p>
                <span>We want you to be happy with your purchase.</span>
              </p>
              <p>
                So we're committed to giving you all the tools to make the right
                decision with minimum fuss.
              </p>
            </div>
          </div>
          ...
          <div class="content-bottom-right">
            ...
            <div class="section group">
              <div class="grid_1_of_4 images_1_of_4">
                <h4>
                  <a>Whirlpool LTE5243D 3.4 CuFt </a>
                </h4>
                <a href="preview.html">
          ...
          <div class="product-articles">
            <ul>
              <li>
                <div class="article">
                  <p>
                    Cras aliquam, odio ac consectetur tincidunt, eros nunc
                    fermentum augue, quis rutrum ante lectus ac lectus. Fusce
                    sed tellus orci, et feugiat urna. Integer et dictum leo.
                    Nulla consectetur tempus orci sed consequat. Mauris cursus
                    est a sapien venenatis faucibus. Etiam sagittis convallis
                    volutpat.
                  </p>
